...
import { Route as HarnessIndexRouteImport } from './routes/harness/index'
...
const HarnessIndexRoute = HarnessIndexRouteImport.update({
  id: '/harness/',
  path: '/harness/',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/harness/': typeof HarnessIndexRoute
...
export interface RootRouteChildren {
  ...
  HarnessIndexRoute: typeof HarnessIndexRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/harness/': {
      ...
      path: '/harness'
      fullPath: '/harness/'
      preLoaderRoute: typeof HarnessIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/oauth/$provider': {
      id: '/oauth/$provider'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  HarnessIndexRoute: HarnessIndexRoute,
